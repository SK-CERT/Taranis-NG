const messages_en = {
  ...
  workflow: {
    ...
    states: {
      tab_description: "Here you can manage states which can be used in workflows.",
      name: "Variable name",
      ...
      system_state_warning:
        "This is a system state which cannot be edited or deleted.",
    ...
    state_workflow: {
      ...
      state_entity_associations: "State Entity Associations",
      state: "State",
      ...
      system_association_warning: "This is a system association which cannot be edited or deleted.",
