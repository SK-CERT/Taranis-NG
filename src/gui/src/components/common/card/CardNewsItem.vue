    ...
    <v-col cols="12" xl="6">
        ...
        >
            ...
            <div class="news-item-action-bar">
                ...
                <v-btn icon tile class="news-item-action" :class="[{'active': newsItem.read}]">
                    <v-icon>
                        $newsItemActionRead
                    </v-icon>
                </v-btn>
                <v-btn icon tile class="news-item-action" :class="[{'active': newsItem.important}]">
                    <v-icon>
                ...
                <v-btn icon tile class="news-item-action" :class="[{'active': newsItem.decorateSource}]">
                    <v-icon>
            ...
            <v-container no-gutters class="ma-0 pa-0">
                <v-row no-gutters>
                    <v-col cols="12" sm="12" md="7" class="d-flex flex-column" align-self="start">
                        <v-container column style="height: 100%">

                            <v-row class="flex-grow-0 mt-0">
                                <v-col class="pb-1">
                                    <h2 class="headline dark-grey--text text-capitalize news-item-headline">
                                        {{ newsItem.title }}
                                    </h2>
                                </v-col>
                            </v-row>
                            ...
                            <v-row class="flex-grow-0 mt-0">
                                <v-col>
                                    <p class="font-weight-light dark-grey--text news-item-excerpt mb-0">
                                        {{ newsItem.excerpt }}
                                    </p>
                                </v-col>
                            </v-row>
                            ...
                            <v-row class="flex-grow-0 mt-1">
                                ...
                                <v-col cols="12" class="mx-0 d-flex justify-start flex-wrap py-1">
                                    <v-btn outlined class="text-lowercase news-item-btn mr-1 mt-1" @click.native.capture="viewTopic($event)">
                                    ...
                                    <div class="d-flex align-start justify-center mr-3 ml-2 mt-1">
                                        <v-icon left small color="awake-green-color" class="align-self-center mr-1">mdi-arrow-up-circle-outline</v-icon>
                                        <span class="text-caption font-weight-light dark-grey--text align-self-center">{{ newsItem.votes.up }}</span>
                                    </div>
                                    <div class="d-flex align-start justify-center mr-3 mt-1">
                                        <v-icon left small color="awake-red-color" class="align-self-center mr-1">mdi-arrow-down-circle-outline</v-icon>
                                        <span class="text-caption font-weight-light dark-grey--text align-self-center">{{ newsItem.votes.down }}</span>
                                    </div>
                                </v-col>
                            </v-row>
                        </v-container>
                    ...
                    <v-col cols="12" sm="12" md="5" class="d-flex flex-column" align-self="start" style="height: 100%">
                        <v-container column style="height: 100%">
                            ...
                            <v-row class="news-item-meta-infos">
                                ...
                                <v-col>
                                    ...
                                    <a :href="newsItem.source.url" target="_blank" icon class="meta-link d-flex">
                            ...
                            <v-row class="news-item-meta-infos">
                                ...
                                <v-col>
                                    <span :class="[{'decorateSource': newsItem.decorateSource}]">
                                        {{ newsItem.addedBy }}
                                        <v-icon right small v-if="newsItem.decorateSource" class="ml-0">$awakeRibbon</v-icon>
                                    </span>
                                </v-col>
                            </v-row>
                            <v-row class="news-item-meta-infos">
                                ...
                                <v-col>
                                    <span v-for="(topic, index) in newsItem.topics" :key="topic" class="text-capitalize">{{ topic }}
                                        <span v-if="index != Object.keys(newsItem.topics).length - 1">, </span>
                                    </span>
                                </v-col>
                            </v-row>
                            <v-row class="news-item-meta-infos">
                                ...
                                <v-col>
                                    <tag-norm v-for="tag in newsItem.tags" :key="tag.label" :tag="tag" />
                                </v-col>
                            </v-row>
