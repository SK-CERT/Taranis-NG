<template>
    <v-data-table :headers="headers" :items="cpes" sort-by="value" class="elevation-1">
        <template v-slot:top>
            <v-toolbar flat>
                        ...
                        <v-card-text>
                            <v-row>
                                <v-col class="mt-6" style="flex-grow: 0">
                                    <EnumSelector :attribute_id="cpe_attribute_id" :value_index="0" cpe_only
                                        @enum-selected="enumSelected" />
                                </v-col>

                                <v-col cols="10">
                                    <v-text-field v-model="edited_cpe.value" :label="$t('asset.value')"
