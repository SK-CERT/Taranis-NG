    ...
    <v-row v-bind="UI.DIALOG.ROW.WINDOW">
        ...
        <v-dialog v-bind="UI.DIALOG.FULLSCREEN" v-model="visible" @keydown.esc="cancel" new-product>
            <MessageBox v-model="showCloseConfirmation" :title="$t('confirm_close.title')"
                ...
                icon="mdi-help-circle" iconColor="warning"
                ...
                <v-form @submit.prevent="addProduct" id="form" ref="form" class="px-4">
                    ...
                    <v-row>
                        <MessageBox v-model="msgbox_visible" @yes="publishProduct" @cancel="msgbox_visible = false"
                            ...
                            icon="mdi-help-circle" iconColor="primary">
                        </MessageBox>
                    </v-row>
...
export default {
    ...
    watch: {
        ...
        product: {
            handler() {
                if (!this.edit && this.visible && this.initialFormState !== null) {
    ...
    methods: {
        addEmptyProduct() {
            ...
            // Set initial form state after a short delay to avoid detecting initialization as changes
            this.$nextTick(() => {
