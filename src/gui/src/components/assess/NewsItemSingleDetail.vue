                            ...
                            <v-row justify="center" class="px-8">
                                    ...
                                    <v-flex>
                                        <v-row class="text-center">
                                            <v-col>
                                                ...
                                                <span class="caption">{{
                                                    news_item.news_items[0].news_item_data.collected }}</span>
                                            </v-col>
                                            <v-col>
                                                <span class="overline font-weight-bold">{{ $t('assess.published')
                                                }}</span><br>
                                                <span class="caption">{{
                                                    news_item.news_items[0].news_item_data.published }}</span>
                                            </v-col>
                                            <v-col>
                                                <span class="overline font-weight-bold">{{ $t('assess.source')
                                                }}</span><br>
                                                <span class="caption">{{ news_item.news_items[0].news_item_data.source
                                                }}</span>
                                            </v-col>
                                            <v-col>
                                                <span class="overline font-weight-bold">{{ $t('assess.author')
                                                }}</span><br>
                                                <span class="caption">{{ news_item.news_items[0].news_item_data.author
                                                }}</span>
                                            </v-col>
                                        </v-row>
                                    </v-flex>
                                ...
                                <v-row class="headline">
                                    <span class="display-1 font-weight-light py-4">{{
                                        news_item.news_items[0].news_item_data.title }}</span>
                                </v-row>
                                <v-row class="py-4">
