...
describe('DeleteConfirmationDialog', () => {
    ...
    describe('confirm', () => {
        it('should emit confirm when confirm button is clicked', async () => {
            ...
            const confirmBtn = btns.find((b) => b.props('color') === 'error') || btns[btns.length - 1]
    ...
    describe('cancel', () => {
        it('should emit update:modelValue false when cancel button is clicked', async () => {
            ...
            const btns = wrapper.findAllComponents({ name: 'VBtn' })
            const cancelBtn = btns.find((b) => b.props('variant') === 'text') || btns[0]
    ...
    describe('slot', () => {
        it('should render slot content', async () => {
            const wrapper = mountDialog({}, { slots: { default: '<strong>Custom delete warning</strong>' } })
            await wrapper.vm.$nextTick()
