...
describe('Config Store', () => {
    ...
    describe('Load Actions', () => {
        const loadTests = [
            ...
            { action: 'loadExternalUsers', stateKey: 'externalUsers', apiFn: 'getAllExternalUsers' },
        ...
        it.each(loadTests)('$action should fetch data and update $stateKey', async ({ action, stateKey, apiFn }) => {
        ...
        it.each(loadTests)('$action should pass filter data to API call', async ({ action, apiFn }) => {
    ...
    describe('osintSourceGroupsForAssess getter', () => {
        ...
        it('should use translated title for default groups', async () => {
            vi.mocked(configApi.getAllOSINTSourceGroups).mockResolvedValue(makeResponse([{ id: 5, name: 'Default', default: true }]))
