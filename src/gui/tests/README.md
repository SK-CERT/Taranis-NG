...
The GUI test suite combines Vitest component/unit tests with Playwright
browser workflows.

Install once from the repository root, then run the commands below from
`src/gui`. See [../../../docs/testing.md](../../../docs/testing.md) for the
...
`.github/workflows/gui-tests.yml` runs the suite on Chromium, Firefox and
