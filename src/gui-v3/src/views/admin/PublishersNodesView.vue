...
<script setup lang="ts">
    ...
    const editItem = ref<PublishersNodeItem | null>(null)
    ...
    const handleDelete = async (node: PublishersNodeItem): Promise<void> => {
        try {
    ...
    const handleEdit = (item: PublishersNodeItem): void => {
        editItem.value = item
    }
