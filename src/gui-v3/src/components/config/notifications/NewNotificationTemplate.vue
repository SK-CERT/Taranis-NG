<template>
  <v-dialog v-model="dialog" max-width="700" persistent>
    ...
    <v-card>
      <v-card-title>
        <span class="text-h5">
          {{ isEdit ? t('notification_template.edit') : t('notification_template.add_new') }}
        </span>
      </v-card-title>
      ...
      <v-card-text>
        <v-form ref="formRef" @submit.prevent="handleSubmit">
          ...
          <v-text-field
            v-model="localItem.subject"
            :label="t('notification_template.subject')"
            variant="outlined"
            density="comfortable"
            class="mb-3"
            :disabled="saving"
          ...
          <v-textarea
            v-model="localItem.body"
            :label="t('notification_template.body')"
            variant="outlined"
            density="comfortable"
            rows="6"
            :disabled="saving"
