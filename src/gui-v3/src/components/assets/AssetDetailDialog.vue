<template>
    <v-dialog v-model="visible" max-width="900px" persistent @keydown.esc="handleCancel">
        <!-- Confirmation Dialog -->
            ...
            <v-window v-model="activeTab" class="transparent">
                ...
                <v-window-item value="details" style="padding: 24px">
                    <v-form ref="formRef" @submit.prevent="handleSave">
                        ...
                        <v-row class="mt-4">
                            <v-col cols="12" md="6">
                                <v-btn prepend-icon="mdi-content-save" variant="outlined" :disabled="!canModify" @click="handleSave">
                                    {{ $t('common.save') }}
                                </v-btn>
                            </v-col>
                            <v-col cols="12" md="6">
