...
class WordlistUpdaterBot(BaseBot):
    ...
    parameters = [
        Parameter(0, "WORD_LIST_ID", "Word list ID", "ID of word list to update", ParameterType.NUMBER),
        Parameter(0, "WORD_LIST_CATEGORY", "Word list category name", "Name of category of word entries", ParameterType.STRING),
        ...
        Parameter(0, "DELETE", "Delete before update (yes or no)", "Delete word entries before update, default yes", ParameterType.STRING),
    ]
