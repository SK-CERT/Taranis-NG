...
class WordlistUpdaterBot(BaseBot):
    ...
    def execute(self, preset):
        ...
        try:
            data_url = preset.param_key_values["DATA_URL"]
            data_format = preset.param_key_values["FORMAT"]
            word_list_id = preset.param_key_values["WORD_LIST_ID"]
            word_list_category_name = preset.param_key_values["WORD_LIST_CATEGORY"]
            delete_word_entries = preset.param_key_values["DELETE"].lower()
