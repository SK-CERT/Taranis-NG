...
from bots.schema.role import RoleSchema, PermissionSchema
from bots.schema.organization import OrganizationSchema
from bots.schema.word_list import WordListSchema
