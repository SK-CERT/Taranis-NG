...
def upgrade() -> None:
    """Upgrade auto generated by Alembic."""
    op.create_table(
        "acl_entry",
        ...
        sa.Column(
            "item_type",
            sa.Enum("COLLECTOR", "OSINT_SOURCE", "OSINT_SOURCE_GROUP", "WORD_LIST", "REPORT_ITEM_TYPE", "PRODUCT_TYPE", name="itemtype"),
            nullable=True,
        ),
...
def downgrade() -> None:
    """Downgrade auto generated by Alembic."""
