...
def upgrade():
    ...
    op.create_foreign_key(
        "news_item_data_news_item_attribute_news_item_attribute_id_fkey",
    ...
    op.create_foreign_key(
        "news_item_aggregate_news_item_attri_news_item_attribute_id_fkey",
    ...
    op.create_foreign_key(
        "news_item_data_news_item_attribute_news_item_data_id_fkey",
        "news_item_data_news_item_attribute",
        "news_item_data",
        ["news_item_data_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "news_item_news_item_data_id_fkey",
        "news_item",
        "news_item_data",
        ["news_item_data_id"],
        ["id"],
    ...
    # news_item_aggregate
    op.create_foreign_key(
        "news_item_aggregate_news_item_attri_news_item_aggregate_id_fkey",
        "news_item_aggregate_news_item_attribute",
        "news_item_aggregate",
    ...
    op.create_foreign_key(
        "report_item_news_item_aggregate_news_item_aggregate_id_fkey",
    ...
    op.create_foreign_key(
        "news_item_aggregate_search_index_news_item_aggregate_id_fkey",
    ...
    op.create_foreign_key(
        "news_item_news_item_aggregate_id_fkey",
        "news_item",
        "news_item_aggregate",
        ["news_item_aggregate_id"],
        ["id"],
