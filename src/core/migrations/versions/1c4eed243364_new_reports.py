...
def upgrade():
    ...
    op.create_foreign_key('product_type_parameter_value_product_type_id_fkey', 'product_type_parameter_value', 'product_type', ['product_type_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key('product_type_parameter_value_parameter_value_id_fkey', 'product_type_parameter_value', 'parameter_value', ['parameter_value_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key('attribute_group_item_attribute_id_fkey', 'attribute_group_item', 'attribute', ['attribute_id'], ['id'], ondelete='CASCADE')
    # report_item_type -> attribute_group -> attribute_group_item
    op.create_foreign_key('attribute_group_report_item_type_id_fkey', 'attribute_group', 'report_item_type', ['report_item_type_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key('attribute_group_item_attribute_group_id_fkey', 'attribute_group_item', 'attribute_group', ['attribute_group_id'], ['id'], ondelete='CASCADE')
    ...
    if rit:
        ...
        if ag:
            agi = session.query(AttributeGroupItem_1c4eed243364).filter_by(title = 'Affected systems CPE Codes', attribute_group_id = ag.id).first()
        ...
        for key, value in data.items():
            ...
            for key2, value2 in value["ag"].items():
                ...
                for key3, value3 in value2["agi"].items():
                    session.add(AttributeGroupItem_1c4eed243364(value3["tit"], value3["des"], key3, value3["min"], value3["max"], ag.id, value3["aid"],))
                    session.commit()
    else:
...
def downgrade():
    delete_previous()
    # product_type -> product_type_parameter_value
    op.create_foreign_key('product_type_parameter_value_product_type_id_fkey', 'product_type_parameter_value', 'product_type', ['product_type_id'], ['id'])
    # parameter -> parameter_value -> product_type_parameter_value
    op.create_foreign_key('parameter_value_parameter_id_fkey', 'parameter_value', 'parameter', ['parameter_id'], ['id'])
    op.create_foreign_key('product_type_parameter_value_parameter_value_id_fkey', 'product_type_parameter_value', 'parameter_value', ['parameter_value_id'], ['id'])
    # attribute -> attribute_enum
    ...
    op.create_foreign_key('attribute_group_item_attribute_group_id_fkey', 'attribute_group_item', 'attribute_group', ['attribute_group_id'], ['id'])
