...
class ScheduledTasksCollector(BaseCollector):
    ...
    parameters = [
        Parameter(0, "TASK_TITLE", "Task title", "Title of scheduled task", ParameterType.STRING),
        Parameter(0, "TASK_COMMAND", "Task command", "Command which will be executed", ParameterType.STRING),
        Parameter(0, "TASK_DESCRIPTION", "Task description", "Description of scheduled task", ParameterType.STRING),
    ]
