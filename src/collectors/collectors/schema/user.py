...
from collectors.schema.role import RoleSchema, PermissionSchema
from collectors.schema.organization import OrganizationSchema
from collectors.schema.word_list import WordListSchema
