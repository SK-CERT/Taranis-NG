...
class BaseCollector:
    ...
    parameters = [
        ...
        Parameter(
            0, "REFRESH_INTERVAL", "Refresh interval in minutes", "How often is this collector queried for new data", ParameterType.NUMBER
        ),
    ]
    ...
    def timezone_info():
        timezone_info = {
            "A": tz.gettz("UTC +1"),
            "ACDT": tz.gettz("UTC +10:30"),
            "ACST": tz.gettz("UTC +9:30"),
            "ACT": tz.gettz("UTC -5"),
            "ACWST": tz.gettz("UTC +8:45"),
            "ADT": tz.gettz("UTC +4"),
            "AEDT": tz.gettz("UTC +11"),
            "AEST": tz.gettz("UTC +10"),
            "AET": tz.gettz("UTC +10"),
            "AFT": tz.gettz("UTC +4:30"),
            "AKDT": tz.gettz("UTC -8"),
            "AKST": tz.gettz("UTC -9"),
            "ALMT": tz.gettz("UTC +6"),
            "AMST": tz.gettz("UTC -3"),
            "AMT": tz.gettz("UTC -4"),
            "ANAST": tz.gettz("UTC +12"),
            "ANAT": tz.gettz("UTC +12"),
            "AQTT": tz.gettz("UTC +5"),
            "ART": tz.gettz("UTC -3"),
            "AST": tz.gettz("UTC +3"),
            "AT": tz.gettz("UTC -4"),
            ...
            "CAST": tz.gettz("UTC +8"),
            "CAT": tz.gettz("UTC +2"),
            "CCT": tz.gettz("UTC +6:30"),
            "CDT": tz.gettz("UTC -5"),
            "CEST": tz.gettz("UTC +2"),
            "CET": tz.gettz("UTC +1"),
            "CHADT": tz.gettz("UTC +13:45"),
            "CHAST": tz.gettz("UTC +12:45"),
            "CHOST": tz.gettz("UTC +9"),
            "CHOT": tz.gettz("UTC +8"),
            "CHUT": tz.gettz("UTC +10"),
            "CIDST": tz.gettz("UTC -4"),
            "CIST": tz.gettz("UTC -5"),
            "CKT": tz.gettz("UTC -10"),
            "CLST": tz.gettz("UTC -3"),
            "CLT": tz.gettz("UTC -4"),
            ...
            "CVT": tz.gettz("UTC -1"),
            "CXT": tz.gettz("UTC +7"),
            "CHST": tz.gettz("UTC +10"),
            "D": tz.gettz("UTC +4"),
            "DAVT": tz.gettz("UTC +7"),
            "DDUT": tz.gettz("UTC +10"),
            "E": tz.gettz("UTC +5"),
            "EASST": tz.gettz("UTC -5"),
            "EAST": tz.gettz("UTC -6"),
            "EAT": tz.gettz("UTC +3"),
            "ECT": tz.gettz("UTC -5"),
            "EDT": tz.gettz("UTC -4"),
            ...
            "IDT": tz.gettz("UTC +3"),
            "IOT": tz.gettz("UTC +6"),
            "IRDT": tz.gettz("UTC +4:30"),
            "IRKST": tz.gettz("UTC +9"),
            "IRKT": tz.gettz("UTC +8"),
            "IRST": tz.gettz("UTC +3:30"),
            "IST": tz.gettz("UTC +5:30"),
            "JST": tz.gettz("UTC +9"),
            "K": tz.gettz("UTC +10"),
            "KGT": tz.gettz("UTC +6"),
            "KOST": tz.gettz("UTC +11"),
            "KRAST": tz.gettz("UTC +8"),
            "KRAT": tz.gettz("UTC +7"),
            "KST": tz.gettz("UTC +9"),
            "KUYT": tz.gettz("UTC +4"),
            "L": tz.gettz("UTC +11"),
            "LHDT": tz.gettz("UTC +11"),
            "LHST": tz.gettz("UTC +10:30"),
            "LINT": tz.gettz("UTC +14"),
            "M": tz.gettz("UTC +12"),
            "MAGST": tz.gettz("UTC +12"),
            "MAGT": tz.gettz("UTC +11"),
            "MART": tz.gettz("UTC -9:30"),
            "MAWT": tz.gettz("UTC +5"),
            "MDT": tz.gettz("UTC -6"),
            "MHT": tz.gettz("UTC +12"),
            "MMT": tz.gettz("UTC +6:30"),
            "MSD": tz.gettz("UTC +4"),
            "MSK": tz.gettz("UTC +3"),
            "MST": tz.gettz("UTC -7"),
            "MT": tz.gettz("UTC -7"),
            ...
            "N": tz.gettz("UTC -1"),
            "NCT": tz.gettz("UTC +11"),
            "NDT": tz.gettz("UTC -2:30"),
            "NFT": tz.gettz("UTC +11"),
            "NOVST": tz.gettz("UTC +7"),
            "NOVT": tz.gettz("UTC +7"),
            "NPT": tz.gettz("UTC +5:45"),
            "NRT": tz.gettz("UTC +12"),
            "NST": tz.gettz("UTC -3:30"),
            "NUT": tz.gettz("UTC -11"),
            "NZDT": tz.gettz("UTC +13"),
            "NZST": tz.gettz("UTC +12"),
            "O": tz.gettz("UTC -2"),
            "OMSST": tz.gettz("UTC +7"),
            "OMST": tz.gettz("UTC +6"),
            "ORAT": tz.gettz("UTC +5"),
            "P": tz.gettz("UTC -3"),
            "PDT": tz.gettz("UTC -7"),
            "PET": tz.gettz("UTC -5"),
            "PETST": tz.gettz("UTC +12"),
            "PETT": tz.gettz("UTC +12"),
            "PGT": tz.gettz("UTC +10"),
            "PHOT": tz.gettz("UTC +13"),
            "PHT": tz.gettz("UTC +8"),
            "PKT": tz.gettz("UTC +5"),
            "PMDT": tz.gettz("UTC -2"),
            "PMST": tz.gettz("UTC -3"),
            "PONT": tz.gettz("UTC +11"),
            "PST": tz.gettz("UTC -8"),
            "PT": tz.gettz("UTC -8"),
            "PWT": tz.gettz("UTC +9"),
            "PYST": tz.gettz("UTC -3"),
            ...
            "ROTT": tz.gettz("UTC -3"),
            "S": tz.gettz("UTC -6"),
            "SAKT": tz.gettz("UTC +11"),
            "SAMT": tz.gettz("UTC +4"),
            "SAST": tz.gettz("UTC +2"),
            "SBT": tz.gettz("UTC +11"),
            "SCT": tz.gettz("UTC +4"),
            "SGT": tz.gettz("UTC +8"),
            "SRET": tz.gettz("UTC +11"),
            "SRT": tz.gettz("UTC -3"),
            "SST": tz.gettz("UTC -11"),
            "SYOT": tz.gettz("UTC +3"),
            "T": tz.gettz("UTC -7"),
            "TAHT": tz.gettz("UTC -10"),
            "TFT": tz.gettz("UTC +5"),
            "TJT": tz.gettz("UTC +5"),
            "TKT": tz.gettz("UTC +13"),
            "TLT": tz.gettz("UTC +9"),
            "TMT": tz.gettz("UTC +5"),
            "TOST": tz.gettz("UTC +14"),
            "TOT": tz.gettz("UTC +13"),
            "TRT": tz.gettz("UTC +3"),
            "TVT": tz.gettz("UTC +12"),
            "U": tz.gettz("UTC -8"),
            "ULAST": tz.gettz("UTC +9"),
            "ULAT": tz.gettz("UTC +8"),
            "UTC": tz.gettz("UTC"),
            "UYST": tz.gettz("UTC -2"),
            "UYT": tz.gettz("UTC -3"),
            ...
            "V": tz.gettz("UTC -9"),
            "VET": tz.gettz("UTC -4"),
            "VLAST": tz.gettz("UTC +11"),
            "VLAT": tz.gettz("UTC +10"),
            "VOST": tz.gettz("UTC +6"),
            "VUT": tz.gettz("UTC +11"),
            "W": tz.gettz("UTC -10"),
            "WAKT": tz.gettz("UTC +12"),
            "WARST": tz.gettz("UTC -3"),
            "WAST": tz.gettz("UTC +2"),
            "WAT": tz.gettz("UTC +1"),
            "WEST": tz.gettz("UTC +1"),
            "WET": tz.gettz("UTC +0"),
            ...
            "X": tz.gettz("UTC -11"),
            "Y": tz.gettz("UTC -12"),
            "YAKST": tz.gettz("UTC +10"),
            "YAKT": tz.gettz("UTC +9"),
            "YAPT": tz.gettz("UTC +10"),
            "YEKST": tz.gettz("UTC +6"),
            "YEKT": tz.gettz("UTC +5"),
            "Z": tz.gettz("UTC +0"),
        }
